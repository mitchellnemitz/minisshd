...
// Mirror of the §13.3 in-process test harness. The shared helper lives in
// internal/server/testhelpers_integration_test.go (package server_test);
// this file duplicates the surface so auth_test, which lives in a
// different package, can drive the server end-to-end.
