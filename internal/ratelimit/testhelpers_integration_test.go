...
// Mirror of the §13.3 in-process test harness. Limiter integration tests
// need access to limiter.Snapshot() to verify per-IP state, so we keep a
// dedicated harness in this package.
